...
- **Throughput follow-ups before the full-universe backfill:** sweep-dedup (`crosscheck_sweep`
  ...
  fixed with round-robin) + **OHLCV bulk-objectify** (0037 — the price backfill is ~95% of the
