 ...
 */
type AltProvider = 'yahoo' | 'mubasher_csv' | 'msx-company-chart' | 'bhb_webapi';
function providerOf(source: SourceRecord): AltProvider | undefined {
  ...
  return p === 'yahoo' || p === 'mubasher_csv' || p === 'msx-company-chart' || p === 'bhb_webapi' ? p : undefined;
}
